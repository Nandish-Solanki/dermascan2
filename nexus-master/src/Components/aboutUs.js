      ...
      <div className="div-about">
        <div className="overlap-about">
          ...
          <p className="welcome-to-dermalyze-about">
            ...
            values. Trust Dermalyze for convenience, accuracy, and a holistic approach – because your skin deserves the
            best. Together, we&#39;re on a heartfelt mission to bring the gift of healthy skin to your fingertips.
          </p>    
        </div>
        <div className="rectangle-about"></div>
        <div className="rectangle-2-about"></div>
        <div className="rectangle-3-about"></div>
        <div className="rectangle-4-about"></div>
        <div className="rectangle-5-about"></div>
        ...
        <div className="MADE-WITH-TEAM-wrapper-about">
          <p className="MADE-WITH-TEAM-about">
            <span className="span-about">MADE WITH </span>
            <span className="text-wrapper-6-about">❤ </span>
            <span className="span-about">TEAM NEURAL NEXUS</span>
          </p>
        </div>
      </div>
    </div>
